          ...
          <form onSubmit={handleResetPassword} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full border border-[var(--color-outline)] rounded-lg px-3 py-2.5 text-[var(--color-card-text)] bg-[var(--color-surface)] placeholder:text-[var(--color-on-surface-variant)] text-center tracking-widest text-lg"
              />
            </div>
            <div>
