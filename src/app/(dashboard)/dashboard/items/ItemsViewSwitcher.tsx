...
import { ItemsListDrawerProvider } from "./ItemsListDrawerContext";
...
export function ItemsViewSwitcher({
  ...
  const isIndex = pathname === "/dashboard/items";
  const {
    sidebarList,
    companyId,
    totalCount,
  ...
  return (
    <ItemsListDrawerProvider openListDrawer={() => setListDrawerOpen(true)}>
